...
$bgLoginUrl     = !empty($cfg['bg_login'])
                    ? base_url($cfg['bg_login'])
                    : base_url('assets/img/back.jpg');
?>
<!DOCTYPE html>
<html lang="id">
<head>
  ...
  <style>
    ...
    *{ box-sizing: border-box; }
    ...
    .auth-page{ display:grid; grid-template-columns:1.1fr 0.9fr; min-height:100vh; position:relative; }
    ...
    .input{
      width:100%; padding:14px 44px 14px 14px; border-radius:12px; border:1px solid #dfe7ff;
...
<body>
  <main class="auth-page">
    ...
    <section class="hero" aria-label="Brand">
      <div class="hero-top">
        <img src="<?= $logoPath ?>" alt="<?= html_escape($appName) ?>" />
      </div>
