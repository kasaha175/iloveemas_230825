...
<style>
  ...
  .mc-col-action{ width:100px; }
  .mc-col-no{ width:56px; }
  .mc-ellipsis{ max-width:420px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  ...
  /* Spinner processing (overlay ringan) */
  .mc-wrap .dataTables_wrapper .dataTables_processing{
    top:0;left:0;right:0;bottom:0;margin:0;width:auto;height:auto;
    display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.6);border:0;
  }
  ...
  /* Fallback scroll manual kalau tidak pakai scrollX */
.mc-table-wrap { overflow-x: auto; }

/* Paksa lebar penuh saat DataTables pakai scrollX */
.mc-wrap .dataTables_wrapper .dataTables_scrollHeadInner,
.mc-wrap .dataTables_wrapper .dataTables_scrollHeadInner table,
.mc-wrap .dataTables_wrapper .dataTables_scrollBody > table,
.mc-table { width: 100% !important; }
...
<div class="mc-wrap">
  <div class="mc-container">
    ...
    <header class="mc-head">
      <h1>Master Cabang</h1>
      <p>Kelola daftar cabang/gerai di aplikasi <strong>I Love Emas</strong>.</p>
    </header>

    <!-- Actions -->
    <div class="mc-actions">
      <a href="<?= base_url('master/addcabang') ?>" class="btn-add">
    ...
    <?php if($this->session->userdata('status')==='success'): ?>
      <div style="margin-top:10px;">
        <span class="mc-badge" style="border-color:#c9f6d1;background:#ecffef;color:#155724;">
    ...
    <!-- Card + Table -->
    <section class="mc-card" aria-label="Data Cabang">
      ...
      <div class="mc-table-wrap">
        <div class="table-responsive">
          <table class="table table-borderless mc-table" id="branchTable">
            <thead>
            <tr>
...
(function waitForDeps(){
  if (!window.jQuery) return setTimeout(waitForDeps, 50);
  if (!jQuery.fn || !jQuery.fn.DataTable) return setTimeout(waitForDeps, 50);
  ...
  var dt = $tbl.DataTable({
    ...
    drawCallback: function(){ dt.columns.adjust(); },
    initComplete: function(){ dt.columns.adjust(); },
    language:{
  ...
  $('#branchTable').on('xhr.dt', function (e, s, json) {
